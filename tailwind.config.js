...
const borderColor = {
  primary: generateColorClass("border-color"),
};
...
module.exports = {
  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        landscape:
          "url('https://images.pexels.com/photos/6469/red-hands-woman-creative.jpg?cs=srgb&dl=pexels-kaboompics-com-6469.jpg&fm=jpg')",
      },
      animation: {
